...
const navigation = [
  ...
  { name: 'City Council', href: '#', current: false },
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-neutral-off-white text-neutral-off-black' : 'text-neutral-off-black hover:bg-gray-700 hover:text-white',
            ...
            <div className="space-y-1 px-2 pt-2 pb-3">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-gray-900 text-white' : 'text-neutral-off-black hover:bg-gray-700 hover:text-white',
